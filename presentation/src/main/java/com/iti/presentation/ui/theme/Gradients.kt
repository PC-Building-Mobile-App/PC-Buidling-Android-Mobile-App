...
val OfficeGradient = Brush.linearGradient(listOf(OfficeGradientStart, OfficeGradientEnd))
val AiWorkstationGradient = Brush.linearGradient(listOf(AiWorkstationGradientStart, AiWorkstationGradientEnd))
val DreamBuildsGradient = Brush.linearGradient(listOf(DreamBuildsGradientStart, DreamBuildsGradientEnd))
